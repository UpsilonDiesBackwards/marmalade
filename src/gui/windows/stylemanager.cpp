...
void StyleManager::LoadStyle(const std::string& stylePath) {
    ...
    while (file >> token) {
        if (token == "Color") {
        ...
        } else if (token == "WindowBorderEnabled") {
            int enabled;
            file >> enabled;
            style.WindowBorderSize = enabled ? 1.0f : 0.0f;
        } else if (token == "Alpha")
            file >> style.Alpha;
        else if (token == "DisabledAlpha")
            file >> style.DisabledAlpha;
        else if (token == "WindowPadding")
            file >> style.WindowPadding.x >> style.WindowPadding.y;
        else if (token == "WindowRounding")
            file >> style.WindowRounding;
        else if (token == "WindowBorderSize")
            file >> style.WindowBorderSize;
        else if (token == "WindowMinSize")
            file >> style.WindowMinSize.x >> style.WindowMinSize.y;
        else if (token == "WindowTitleAlign")
            file >> style.WindowTitleAlign.x >> style.WindowTitleAlign.y;
        else if (token == "ChildRounding")
            file >> style.ChildRounding;
        else if (token == "ChildBorderSize")
            file >> style.ChildBorderSize;
        else if (token == "PopupRounding")
            file >> style.PopupRounding;
        else if (token == "PopupBorderSize")
            file >> style.PopupBorderSize;
        else if (token == "FramePadding")
            file >> style.FramePadding.x >> style.FramePadding.y;
        else if (token == "FrameRounding")
            file >> style.FrameRounding;
        else if (token == "FrameBorderSize")
            file >> style.FrameBorderSize;
        else if (token == "ItemSpacing")
            file >> style.ItemSpacing.x >> style.ItemSpacing.y;
        else if (token == "ItemInnerSpacing")
            file >> style.ItemInnerSpacing.x >> style.ItemInnerSpacing.y;
        else if (token == "CellPadding")
            file >> style.CellPadding.x >> style.CellPadding.y;
        else if (token == "TouchExtraPadding")
            file >> style.TouchExtraPadding.x >> style.TouchExtraPadding.y;
        else if (token == "IndentSpacing")
            file >> style.IndentSpacing;
        else if (token == "ColumnsMinSpacing")
            file >> style.ColumnsMinSpacing;
        else if (token == "ScrollbarSize")
            file >> style.ScrollbarSize;
        else if (token == "ScrollbarRounding")
            file >> style.ScrollbarRounding;
        else if (token == "GrabMinSize")
            file >> style.GrabMinSize;
        else if (token == "GrabRounding")
            file >> style.GrabRounding;
        else if (token == "LogSliderDeadzone")
            file >> style.LogSliderDeadzone;
        else if (token == "TabRounding")
            ...
            file >> style.DisplaySafeAreaPadding.x >> style.DisplaySafeAreaPadding.y;
        else if (token == "MouseCursorScale")
            file >> style.MouseCursorScale;
        else if (token == "AntiAliasedLines")
            file >> style.AntiAliasedLines;
        else if (token == "AntiAliasedLinesUseTex")
            file >> style.AntiAliasedLinesUseTex;
        else if (token == "AntiAliasedFill")
            file >> style.AntiAliasedFill;
        else if (token == "CurveTessellationTol")
            file >> style.CurveTessellationTol;
        else if (token == "CircleTessellationMaxError")
...
void StyleManager::SaveStyle(const std::string& stylePath) {
    ImGuiStyle& style = ImGui::GetStyle();
    ...
    file << "WindowBorderEnabled " << (style.WindowBorderSize > 0.0f ? 1 : 0) << "\n";
